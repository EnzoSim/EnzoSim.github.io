...
// Values render next to per-language labels, index-matched with fda.metricLabels.
export const fdaMetricValues = ['128', '101', '23', '100']

// Index-matched with library.books in each language dictionary.
